// [EXPORT] //
module.exports = {
	parallaxImg: require('../../assets/media/pages/about/parallax.png'),
	...
	r1: {
		...
		c2: {
			image: require('../../assets/media/pages/about/group-shot.jpg'),
		},
	},
	...
	r2: {
		...
		c2: {
			images: [
				require('../../assets/media/pages/about/small-group.jpg'),
				require('../../assets/media/pages/about/jason.webp'),
				require('../../assets/media/pages/about/workers.jpg'),
				require('../../assets/media/pages/about/harry.webp'),
				require('../../assets/media/pages/about/group-shot.jpg'),
				require('../../assets/media/pages/about/jason.webp'),
			],
		...
		cx: [
			{
				image: require('../../assets/media/pages/about/jason.webp'),
				name: 'Jason Tielve',
				title: 'Co-Owner & CEO',
			...
			{
				image: require('../../assets/media/pages/about/harry.webp'),
	...
	r3: {
		...
		c3: { image: require('../../assets/media/our-mission.webp'), },
	},
}
...
module.exports = {
	fireSprinklerInspectionReport: (test) => {
		...
		generalSection.forEach(gs => {
			...
			generalSectionHTML = generalSectionHTML + html
		})
		...
		return `
			...
			<div class="container page">
				...
				<div class="row mb-3">
					<!-- Title -->
					<div class="col-12">
						<h4 class="mb-3 font-weight-bold">Inspection Conducted By</h4>
					</div>
					...
					<!-- Company Detailss -->
					<div class="col-4">
						<h5 class="font-weight-bold">24/7 Fire Protection Inc.</h5>
						<h5>123 main st, teaneck, nj</h5>
			
						<h5>Phone: 123 123 1234</h5>
						<h5>Fax: 123 123 1234</h5>
					</div>
			
					<!-- Inspector -->
					<div class="col-4">
						<h5 class="font-weight-bold">Inspected By:</h5>
						<h5 class="mb-3">Elis Rosado</h5>
			...
			<div class="container page">
				...
				<div class="row mb-3">
					...
					<div class="col-4">
						<h6 class="font-weight-bold">SIRJ NJ LLC</h6>
						<h6>177 North Dead Street Suite 301, Englewood, NJ 07631</h6>
						<h6>Phone: Phone: 347-213-1643</h6>
						<h6>Email: zishaberger@gmail.com</h6>
					</div>
				...
				<!-- THE PARTIES UNDERSTAND AND VOLUNTARILLY AGREE AS FOLLOWS -->
				<div class="row mb-3">
					<div class="col-12">
					...
					<div class="col-12">
						<ul>
							...
							<li>Report of Inspection</li>
							<li>
								Notice of this agreement and copies of all Reports of inspection and or will be forward by the Contractor to authority having jurisdiction, where required, and to the Subscriber. Notice of termination shall bereported to authority having jurisdiction by Contractor.
							</li>
							...
							<li>Emergency service requested by the Subscriber will be furnished at an extra charge.</li>
				...
				<div class="row mb-3">
					...
					<!-- Client Signature -->
					<div class="col-6">
						<div class="badge badge-warning">(no client signature)</div>
						<p>SIRJ NJ LLC</p>
					</div>
					...
					<div class="col-12">
						<p>
							INSPECTOR acknowledges by signing below that he/she is acting on behalf of 24/7 Fire Protection Inc. in performance of inspection services agreed to in the foregoing.
						</p>
					</div>
			
					<!-- Inspector Signature -->
					<div class="col-6">
						<div class="badge badge-warning">(no Inspector signature)</div>
						<p>Elis Rosado</p>
					</div>
